...
QUESTION = (
    "A vendor breached a contract, shared user data without consent, and failed to pay "
    "taxes on overseas revenue. What legal consequences and case law apply?"
)
...
SYSTEM_PROMPT = (
    ...
    "compliance, and breach of contract case law. Keep your final answer under 500 words. "
    "Debug note: this demo streams each ReAct tool decision and observation below."
)
